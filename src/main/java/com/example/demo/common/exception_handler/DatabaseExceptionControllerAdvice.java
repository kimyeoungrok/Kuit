...
import static com.example.demo.response.status.BaseExceptionResponseStatus.BAD_SQL_GRAMMAR;
import static com.example.demo.response.status.BaseExceptionResponseStatus.DATABASE_ERROR;
